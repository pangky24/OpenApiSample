...
import com.stock.common.model.Constants;
import com.stock.common.util.PropertiesReader;
import com.stock.login.SampleActivity;

//로그인 뷰
@SuppressLint("ClickableViewAccessibility")
public class SamlpeLoginView extends FrameLayout {

    public void setCustomerSetData(SampleActivity sampleActivity) {
        if (PropertiesReader.getStockProperty(Constants.USER_ID) != null) {
            this.setUserId(PropertiesReader.getStockProperty(Constants.USER_ID));
        }

        if (PropertiesReader.getStockProperty(Constants.USER_PWD) != null) {
            this.setUserPwd(PropertiesReader.getStockProperty(Constants.USER_PWD));
        }

        if (PropertiesReader.getStockProperty(Constants.USER_CERT_PWD) != null) {
            this.setCertPwd(PropertiesReader.getStockProperty(Constants.USER_CERT_PWD));
        }
