...
import com.stock.common.ui.SampleBaseView;
import com.stock.common.util.PropertiesReader;
import com.stock.data.ui.SampleDataView;
import com.stock.order.ui.SampleOrderView;
import com.stock.login.ui.SamlpeLoginView;
...
public class SampleActivity extends Activity implements View.OnClickListener, IExpertInitListener, IExpertLoginListener {
    ...
    public void onInitFinished() {
        ...
        m_viewLogin.setCustomerSetData(this);
    ...
    public void onClick(View v) {
        ...
        //로그인 시작
        if (CommExpertMng.getInstance().GetMotu())
            CommExpertMng.getInstance().StartLogin(m_viewLogin.getUserId(), m_viewLogin.getUserPwd());
        else
            CommExpertMng.getInstance().StartLogin(m_viewLogin.getUserId(), m_viewLogin.getUserPwd(), m_viewLogin.getCertPwd());
    }
